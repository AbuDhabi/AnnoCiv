...
GameState gs; 
Unit PROTOTYPE_INFANTRY = {IMG_UNIT_INFANTRY,-1,-1,10,10,1,1,MOVE_TYPE_GROUND,0,-1};
Unit PROTOTYPE_CAVALRY = {IMG_UNIT_CAVALRY,-1,-1,10,10,2,2,MOVE_TYPE_GROUND,0,-1};
Unit PROTOTYPE_ARMOUR = {IMG_UNIT_ARMOUR,-1,-1,10,10,2,2,MOVE_TYPE_GROUND,0,-1};
Unit PROTOTYPE_ARTILLERY = {IMG_UNIT_ARTILLERY,-1,-1,10,10,1,2,MOVE_TYPE_GROUND,0,-1};
Unit PROTOTYPE_BATTLESHIP = {IMG_UNIT_BATTLESHIP,-1,-1,10,10,4,5,MOVE_TYPE_SEA,0,-1};
Unit PROTOTYPE_SUBMARINE = {IMG_UNIT_SUBMARINE,-1,-1,10,10,4,5,MOVE_TYPE_SEA,0,-1};
Unit PROTOTYPE_SEATRANSPORT = {IMG_UNIT_SEATRANSPORT,-1,-1,10,10,1,5,MOVE_TYPE_SEA,5,-1};
Unit PROTOTYPE_FIGHTER = {IMG_UNIT_FIGHTER,-1,-1,10,10,5,20,MOVE_TYPE_AIR,0,-1};
Unit PROTOTYPE_BOMBER = {IMG_UNIT_BOMBER,-1,-1,10,10,5,15,MOVE_TYPE_AIR,0,-1};
Unit PROTOTYPE_AIRTRANSPORT = {IMG_UNIT_AIRTRANSPORT,-1,-1,10,10,1,10,MOVE_TYPE_AIR,1,-1};
Unit PROTOTYPE_MISSILE = {IMG_UNIT_MISSILE,-1,-1,10,10,20,40,MOVE_TYPE_AIR,0,-1};
Unit PROTOTYPE_WORKERS = {IMG_UNIT_WORKERS,-1,-1,10,10,1,2,MOVE_TYPE_GROUND,0,-1};
